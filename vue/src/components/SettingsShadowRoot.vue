  ...
  const SettingsShadownRoot = defineCustomElement({
    styles: [`
      fieldset {
      line-height: 1.9;
    ...
    label {
      ...
      template:`
        <fieldset>
          <legend>Notification settings Shadown Root: {{selected == 0 ? 'Show notifications' : (
  ...
  // customElements.define("my-vue-web-comp-shadown-root", SettingsShadownRoot);
  export default SettingsShadownRoot;
</script>